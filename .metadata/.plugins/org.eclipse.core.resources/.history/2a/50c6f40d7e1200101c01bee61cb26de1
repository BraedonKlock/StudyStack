...
public class NotesManager {
    ...
    public static void CreateNote() {
        System.out.println("Do you want to create a new note? (1 = Yes / 2 = No: ");
        ...
        try {
            ...
            if (!courseInfo.exists()) {
                System.out.println("CourseInfo.txt not found. Open it in Vim? (1 = Yes / 2 = No: ");
            ...
            while (fileName.isEmpty()) {
                System.out.println("Enter note filename (without extension, or type 'exit' to cancel):");
                ...
                System.out.println("You entered: \"" + fileName + "\". Continue? (1 = Yes / 2 = No: ");
            ...
            System.out.println("Continue to Vim? (1 = Yes / 2 = No: ");
    ...
    private static File selectCourse() {
        ...
        System.out.println("Select a course number (or type 'exit' to cancel):");
    ...
    private static File selectNote(File course) {
        ...
        System.out.println("Select a note number (or type 'exit' to cancel):");
        String input = scanner.nextLine().trim();
        if (input.equalsIgnoreCase("exit")) {
            return null;
        }
